...
int main() {
	...
	//query.d.print();
	fstream dataFile;
	dataFile.open("res.out", ios::out);
	int num = 8;

	//query.path_query = "((<http://www.w3.org/1999/02/22-rdf-syntax-ns#type>*\\<http://swat.cse.lehigh.edu/onto/univ-bench.owl#memberOf>)*)";
	//query.Build_se();
	...
	query.path_query = "((<http://swat.cse.lehigh.edu/onto/univ-bench.owl#undergraduateDegreeFrom>\\<http://www.w3.org/1999/02/22-rdf-syntax-ns#type>*\\<http://swat.cse.lehigh.edu/onto/univ-bench.owl#mastersDegreeFrom>*)*)";
	query.Build_se();
	...
	query.path_query = "((<http://swat.cse.lehigh.edu/onto/univ-bench.owl#doctoralDegreeFrom>\\<http://swat.cse.lehigh.edu/onto/univ-bench.owl#researchInterest>\\<http://swat.cse.lehigh.edu/onto/univ-bench.owl#mastersDegreeFrom>)*\\<http://www.w3.org/1999/02/22-rdf-syntax-ns#type>*)";
	query.Build_se();
